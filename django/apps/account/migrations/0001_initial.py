    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('education', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.education', verbose_name='Education')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_verification', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='account.educationverification', verbose_name='Education Verification')),
            ],
            options={
